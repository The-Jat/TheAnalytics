        ...
        <div class="d-flex justify-content-center">
            <div class="d-flex flex-column flex-lg-row mt-4 mb-4">
                <?php if(settings()->users->register_is_enabled): ?>
                    <a href="<?= url('register') ?>" class="btn btn-primary px-5 py-3 mb-2 mb-lg-0 mr-lg-2">
                        <?= l('index.get_started') ?> <i class="fas fa-fw fa-sm fa-arrow-right"></i>
                    </a>
                <?php endif ?>

                <?php if(settings()->analytics->example_url && settings()->analytics->example_url): ?>
                    <a href="<?= settings()->analytics->example_url ?>" target="_blank" class="btn btn-gray-100 px-5 py-3 mb-2 mb-lg-0" data-toggle="tooltip" title="<?= l('index.example_help') ?>">
...
<div class="container" data-aos="fade-up" data-aos-delay="300">
    <div class="row justify-content-center mt-8">
        <div class="col-11 col-md-10">
            <img src="<?= get_custom_image_if_any('index/hero.webp') ?>" class="img-fluid shadow-lg rounded zoom-animation-subtle" alt="<?= l('index.hero_image_alt') ?>" />
        </div>
    </div>
</div>
...
<div class="container mt-10">
    ...
    <div class="row justify-content-between mt-9" data-aos="fade-up">
        ...
        <div class="col-12 col-md-5 text-center mb-5 mb-md-0 order-0 order-md-1">
            <img src="<?= get_custom_image_if_any('index/visitors.webp') ?>" class="index-highly-rounded img-fluid border border-primary-100" loading="lazy" alt="<?= l('index.visitors_image_alt') ?>" />
        </div>
    </div>

    <div class="row justify-content-between mt-9" data-aos="fade-up">
        <div class="col-12 col-md-5 text-center mb-5 mb-md-0" >
            <img src="<?= get_custom_image_if_any('index/session_events.webp') ?>" class="index-highly-rounded img-fluid border border-primary-100" loading="lazy" alt="<?= l('index.behaviour_image_alt') ?>" />
        </div>
    ...
    <div class="row justify-content-between mt-9" data-aos="fade-up">
        ...
        <div class="col-12 col-md-5 text-center mb-5 mb-md-0 order-0 order-md-1" >
            <img src="<?= get_custom_image_if_any('index/realtime.webp') ?>" class="index-highly-rounded img-fluid border border-primary-100" loading="lazy" alt="<?= l('index.realtime_image_alt') ?>" />
        </div>
    </div>
    ...
    <?php if(settings()->analytics->websites_heatmaps_is_enabled): ?>
        <div class="row justify-content-between mt-9" data-aos="fade-up">
            <div class="col-12 col-md-5 text-center mb-5 mb-md-0" >
                <img src="<?= get_custom_image_if_any('index/heatmaps.webp') ?>" class="img-fluid index-highly-rounded border border-primary-100" loading="lazy" alt="<?= l('index.heatmaps_image_alt') ?>" />
            </div>
    ...
    <?php if(settings()->analytics->sessions_replays_is_enabled): ?>
        <div class="row justify-content-between mt-9" data-aos="fade-up">
            ...
            <div class="col-12 col-md-5 text-center mb-5 mb-md-0 order-0 order-md-1" >
                <img src="<?= get_custom_image_if_any('index/recordings.webp') ?>" class="img-fluid index-highly-rounded border border-primary-100" loading="lazy" alt="<?= l('index.replays_image_alt') ?>" />
            </div>
        </div>
    <?php endif ?>
</div>
    ...
    <div class="row">
        <div class="col-12 col-md-6 col-lg-4 p-4 up-animation">
            <div class="d-flex flex-column justify-content-between h-100" data-aos="fade-up" data-aos-delay="100">
                <img src="<?= get_custom_image_if_any('index/teams.webp') ?>" class="img-fluid rounded mb-4" loading="lazy" alt="<?= l('index.teams_image_alt') ?>" />
        ...
        <div class="col-12 col-md-6 col-lg-4 p-4 up-animation">
            <div class="d-flex flex-column justify-content-between h-100" data-aos="fade-up" data-aos-delay="200">
                <img src="<?= get_custom_image_if_any('index/goals.webp') ?>" class="img-fluid rounded mb-4" loading="lazy" alt="<?= l('index.goals_image_alt') ?>" />
        ...
        <div class="col-12 col-md-6 col-lg-4 p-4 up-animation">
            <div class="d-flex flex-column justify-content-between h-100" data-aos="fade-up" data-aos-delay="200">
                <img src="<?= get_custom_image_if_any('index/overview.webp') ?>" class="img-fluid rounded mb-4" loading="lazy" alt="<?= l('index.export_image_alt') ?>" />
        ...
        <?php if(settings()->analytics->email_reports_is_enabled): ?>
            <div class="col-12 col-md-6 col-lg-4 p-4 up-animation">
                <div class="d-flex flex-column justify-content-between h-100" data-aos="fade-up" data-aos-delay="100">
                    <img src="<?= get_custom_image_if_any('index/email_reports.webp') ?>" class="img-fluid rounded mb-4" loading="lazy" alt="<?= l('index.email_reports_image_alt') ?>" />
        ...
        <?php if(settings()->analytics->domains_is_enabled): ?>
            <div class="col-12 col-md-6 col-lg-4 p-4 up-animation">
                <div class="d-flex flex-column justify-content-between h-100" data-aos="fade-up" data-aos-delay="100">
                    <img src="<?= get_custom_image_if_any('index/domains.webp') ?>" class="img-fluid rounded mb-4" loading="lazy" alt="<?= l('index.domains_image_alt') ?>" />
        ...
        <div class="col-12 col-md-6 col-lg-4 p-4 up-animation">
            <div class="d-flex flex-column justify-content-between h-100" data-aos="fade-up" data-aos-delay="100">
                <img src="<?= get_custom_image_if_any('index/custom_parameters.webp') ?>" class="img-fluid rounded mb-4" loading="lazy" alt="<?= l('index.custom_parameters_image_alt') ?>" />
