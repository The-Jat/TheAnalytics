    ...
    <?php foreach($features as $feature => $is_enabled): ?>
        ...
        <?php if($is_enabled && $feature == 'websites_limit'): ?>
            <li class="d-flex align-items-baseline mb-2">
                <i class="fas fa-fw fa-sm mr-3 <?= $data->plan_settings->websites_limit ? 'fa-check-circle text-success' : 'fa-times-circle text-muted' ?>"></i>
        ...
        <?php if($is_enabled && $feature == 'sessions_events_limit'): ?>
            <li class="d-flex align-items-baseline mb-2">
                <i class="fas fa-fw fa-sm mr-3 <?= $data->plan_settings->sessions_events_limit ? 'fa-check-circle text-success' : 'fa-times-circle text-muted' ?>"></i>
        ...
        <?php if($is_enabled && $feature == 'events_children_limit'): ?>
            <li class="d-flex align-items-baseline mb-2">
                <i class="fas fa-fw fa-sm mr-3 <?= $data->plan_settings->events_children_limit ? 'fa-check-circle text-success' : 'fa-times-circle text-muted' ?>"></i>
        ...
        <?php if($is_enabled && $feature == 'sessions_replays_limit' && settings()->analytics->sessions_replays_is_enabled): ?>
            <li class="d-flex align-items-baseline mb-2">
                <i class="fas fa-fw fa-sm mr-3 <?= $data->plan_settings->sessions_replays_limit ? 'fa-check-circle text-success' : 'fa-times-circle text-muted' ?>"></i>
        ...
        <?php if($is_enabled && $feature == 'sessions_replays_retention' && $data->plan_settings->sessions_replays_limit != 0): ?>
            <li class="d-flex align-items-baseline mb-2">
                <i class="fas fa-fw fa-sm mr-3 fa-check-circle text-success"></i>
        ...
        <?php if($is_enabled && $feature == 'websites_heatmaps_limit' && settings()->analytics->websites_heatmaps_is_enabled): ?>
            <li class="d-flex align-items-baseline mb-2">
                <i class="fas fa-fw fa-sm mr-3 <?= $data->plan_settings->websites_heatmaps_limit ? 'fa-check-circle text-success' : 'fa-times-circle text-muted' ?>"></i>
        ...
        <?php if($is_enabled && $feature == 'websites_goals_limit'): ?>
            <li class="d-flex align-items-baseline mb-2">
                <i class="fas fa-fw fa-sm mr-3 <?= $data->plan_settings->websites_goals_limit ? 'fa-check-circle text-success' : 'fa-times-circle text-muted' ?>"></i>
