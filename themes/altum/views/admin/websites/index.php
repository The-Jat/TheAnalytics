...
<div class="d-flex flex-column flex-md-row justify-content-between mb-4">
    <h1 class="h3 mb-3 mb-md-0 text-truncate"><i class="fas fa-fw fa-xs fa-pager text-primary-900 mr-2"></i> <?= l('admin_websites.header') ?></h1>

    <div class="d-flex position-relative d-print-none">
        <div class="ml-3">
            <a href="<?= url('admin/statistics/websites') ?>" class="btn btn-gray-300" data-tooltip title="<?= l('global.statistics') ?>">
        ...
        <div class="ml-3">
            <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right d-print-none">
                    <a href="<?= url('admin/websites?' . $data->filters->get_get() . '&export=csv')  ?>" target="_blank" class="dropdown-item <?= $this->user->plan_settings->export->csv ? null : 'disabled pointer-events-all' ?>" <?= $this->user->plan_settings->export->csv ? null : get_plan_feature_disabled_info() ?>>
                        <i class="fas fa-fw fa-sm fa-file-csv mr-2"></i> <?= sprintf(l('global.export_to'), 'CSV') ?>
                    </a>
                    <a href="<?= url('admin/websites?' . $data->filters->get_get() . '&export=json') ?>" target="_blank" class="dropdown-item <?= $this->user->plan_settings->export->json ? null : 'disabled pointer-events-all' ?>" <?= $this->user->plan_settings->export->json ? null : get_plan_feature_disabled_info() ?>>
                ...
                <tr>
                    ...
                    <td class="text-nowrap">
                        <div class="d-flex flex-column">
                            ...
                            <div class="small d-flex align-items-center text-muted">
                                ...
                                <a href="<?= $row->scheme . $row->host . $row->path ?>" rel="noreferrer"><i class="fas fa-fw fa-xs fa-external-link-alt text-muted ml-1"></i></a>
                            </div>
                        </div>
                    </td>
                    <td class="text-nowrap">
                    ...
                    <td class="text-nowrap">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="mx-1">
                                <?php if($row->tracking_type == 'normal'): ?>
                                    <span class="badge badge-info" data-toggle="tooltip" title="<?= l('websites.tracking_type_normal') ?>"><i class="fas fa-fw fa-sm fa-brain"></i></span>
                                <?php endif ?>

                                <?php if($row->tracking_type == 'lightweight'): ?>
                                    <span class="badge badge-primary" data-toggle="tooltip" title="<?= l('websites.tracking_type_lightweight') ?>"><i class="fas fa-fw fa-sm fa-feather"></i></span>
                                <?php endif ?>
                            </div>
                        </div>
                    </td>
