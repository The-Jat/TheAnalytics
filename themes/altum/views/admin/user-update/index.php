        ...
        <form action="" method="post" role="form" enctype="multipart/form-data">
            ...
            <div id="plan_settings" style="display: none">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="websites_limit" name="websites_limit" min="-1" class="form-control" value="<?= $data->user->plan_settings->websites_limit ?>" />
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="sessions_events_limit" name="sessions_events_limit" min="-1" class="form-control" value="<?= $data->user->plan_settings->sessions_events_limit ?>" />
                    <small class="form-text text-muted"><?= l('admin_plans.plan.unlimited') ?></small>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="number" id="sessions_events_retention" name="sessions_events_retention" min="-1" class="form-control" value="<?= $data->user->plan_settings->sessions_events_retention ?>" />
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="number" id="events_children_retention" name="events_children_retention" min="-1" class="form-control" value="<?= $data->user->plan_settings->events_children_retention ?>" />
                        <div class="input-group-append">
                            <span class="input-group-text"><?= l('global.date.days') ?></span>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="number" id="sessions_replays_retention" name="sessions_replays_retention" min="-1" class="form-control" value="<?= $data->user->plan_settings->sessions_replays_retention ?>" />
                        <div class="input-group-append">
                            <span class="input-group-text"><?= l('global.date.days') ?></span>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="sessions_replays_time_limit" name="sessions_replays_time_limit" min="1" class="form-control" value="<?= $data->user->plan_settings->sessions_replays_time_limit ?>" />
                ...
                <div class="form-group custom-control custom-switch">
                    <input id="teams_is_enabled" name="teams_is_enabled" type="checkbox" class="custom-control-input" <?= $data->user->plan_settings->teams_is_enabled ? 'checked="checked"' : null ?>>
