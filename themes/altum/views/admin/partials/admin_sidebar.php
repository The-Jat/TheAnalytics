...
<section class="admin-sidebar">
    ...
    <div class="admin-sidebar-links-wrapper">
        <ul class="admin-sidebar-links">
            ...
            <li class="<?= \Altum\Router::$controller == 'AdminHeatmaps' ? 'active' : null ?>">
                <a class="nav-link text-truncate" href="<?= url('admin/heatmaps') ?>">
                    <i class="fas fa-fw fa-sm fa-fire mr-2"></i> <?= l('admin_heatmaps.menu') ?>
                </a>
            </li>

            <li class="<?= \Altum\Router::$controller == 'AdminReplays' ? 'active' : null ?>">
                <a class="nav-link text-truncate" href="<?= url('admin/replays') ?>">
                    <i class="fas fa-fw fa-sm fa-video mr-2"></i> <?= l('admin_replays.menu') ?>
                </a>
            </li>
