...
class AdminSettings extends Controller {
    ...
    public function custom_images() {
        ...
        if(!empty($_POST)) {
            ...
            $images_keys = [
                'index/hero.webp',
                'index/custom_parameters.webp',
                'index/domains.webp',
                'index/email_reports.webp',
                'index/goals.webp',
                'index/heatmaps.webp',
                'index/overview.webp',
                'index/realtime.webp',
                'index/outbound_clicks.webp',
                'index/recordings.webp',
                'index/session_events.webp',
                'index/visitors.webp',
                'index/teams.webp',
    ...
    public function analytics() {
        ...
        if(!empty($_POST)) {
            ...
            $_POST['websites_heatmaps_is_enabled'] = (int) isset($_POST['websites_heatmaps_is_enabled']);
            $_POST['pixel_cache'] = (int) $_POST['pixel_cache'];
            $_POST['pixel_exposed_identifier'] = get_slug($_POST['pixel_exposed_identifier']);
