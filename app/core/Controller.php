...
class Controller {
    ...
    public function run() {
        ...
        if(\Altum\Router::$path == '') {
            ...
            if(in_array(\Altum\Router::$controller_key, ['help'])) {
                \Altum\Router::$controller_settings['wrapper'] = is_logged_in() ? 'app_wrapper' : 'wrapper';
            }
            ...
            if(\Altum\Router::$controller_settings['wrapper'] == 'statistics_wrapper') {
                /* Establish the footer view */
                $footer = new \Altum\View('statistics/partials/footer', (array) $this);
                $this->add_view_content('footer', $footer->run());

                $wrapper = new \Altum\View('statistics/statistics_wrapper', (array) $this);
            }
